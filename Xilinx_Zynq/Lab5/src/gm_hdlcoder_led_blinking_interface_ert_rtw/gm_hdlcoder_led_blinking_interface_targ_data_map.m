  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% gm_hdlcoder_led_blinking_inte_P.Constant3_Value
	  section.data(3).logicalSrcIdx = 3;
	  section.data(3).dtTransOffset = 2;
	
	  ;% gm_hdlcoder_led_blinking_inte_P.Constant4_Value
	  ...
	  ;% gm_hdlcoder_led_blinking_inte_P.ManualSwitch1_CurrentSetting
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% gm_hdlcoder_led_blinking_int_DW.obj_d
	  section.data(1).logicalSrcIdx = 1;
	  section.data(1).dtTransOffset = 0;
	
	  ;% gm_hdlcoder_led_blinking_int_DW.obj_p
	  section.data(2).logicalSrcIdx = 2;
	  section.data(2).dtTransOffset = 1;
	
	  ;% gm_hdlcoder_led_blinking_int_DW.obj_m
	  section.data(3).logicalSrcIdx = 3;
	  section.data(3).dtTransOffset = 2;
  ...
  targMap.checksum0 = 1925305167;
  targMap.checksum1 = 1943612593;
  targMap.checksum2 = 3356300248;
  targMap.checksum3 = 3568909215;
