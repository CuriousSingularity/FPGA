...
typedef struct {
  ...
  zynq_AXIWrite_gm_hdlcoder_led_T obj_d;/* '<S9>/AXI4-Interface Write' */
  zynq_AXIWrite_gm_hdlcoder_led_T obj_p;/* '<S8>/AXI4-Interface Write' */
  zynq_AXIWrite_gm_hdlcoder_led_T obj_m;/* '<S7>/AXI4-Interface Write' */
  struct {
    void *LoggedData;
 ...
 * '<S9>'   : 'gm_hdlcoder_led_blinking_interface/led_counter/AXI4LiteWrite/AXI4Lite_Write_In1'
 */
