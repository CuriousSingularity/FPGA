...
proc create_root_design { parentCell } {
  ...
  set led_count_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:led_count_ip:1.0 led_count_ip_0 ]
  ...
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M00_AXI [get_bd_intf_pins axi_cpu_interconnect/M00_AXI] [get_bd_intf_pins led_count_ip_0/AXI4_Lite]
  ...
  connect_bd_net -net led_count_ip_0_GPLEDs [get_bd_ports GPLEDs] [get_bd_pins led_count_ip_0/GPLEDs]
  ...
  connect_bd_net -net sys_core_clk [get_bd_pins axi_cpu_interconnect/M00_ACLK] [get_bd_pins core_clkwiz/clk_out1] [get_bd_pins led_count_ip_0/AXI4_Lite_ACLK] [get_bd_pins led_count_ip_0/IPCORE_CLK] [get_bd_pins sys_core_rstgen/slowest_sync_clk]
  connect_bd_net -net sys_core_resetn [get_bd_pins axi_cpu_interconnect/M00_ARESETN] [get_bd_pins led_count_ip_0/AXI4_Lite_ARESETN] [get_bd_pins led_count_ip_0/IPCORE_RESETN] [get_bd_pins sys_core_rstgen/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x400D0000 [get_bd_addr_spaces sys_cpu/Data] [get_bd_addr_segs led_count_ip_0/AXI4_Lite/reg0] SEG_led_count_ip_0_reg0
