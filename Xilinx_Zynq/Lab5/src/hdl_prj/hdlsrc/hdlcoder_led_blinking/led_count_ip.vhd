...
ARCHITECTURE rtl OF led_count_ip IS
  ...
  COMPONENT led_count_ip_reset_sync
  ...
  FOR ALL : led_count_ip_reset_sync
    USE ENTITY work.led_count_ip_reset_sync(rtl);
  ...
  SIGNAL write_In1                        : std_logic;  -- ufix1
  SIGNAL ce_out_sig                       : std_logic;  -- ufix1
  SIGNAL LED_sig                          : std_logic_vector(7 DOWNTO 0);  -- ufix8

BEGIN
  u_led_count_ip_reset_sync_inst : led_count_ip_reset_sync
  ...
  ip_timestamp <= to_unsigned(1905281043, 32);
