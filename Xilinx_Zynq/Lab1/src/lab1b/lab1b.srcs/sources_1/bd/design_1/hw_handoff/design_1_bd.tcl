...
proc create_root_design { parentCell } {
  ...
  set btns_5bits_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 btns_5bits_1 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports btns_5bits_1] [get_bd_intf_pins axi_gpio_0/GPIO2]
