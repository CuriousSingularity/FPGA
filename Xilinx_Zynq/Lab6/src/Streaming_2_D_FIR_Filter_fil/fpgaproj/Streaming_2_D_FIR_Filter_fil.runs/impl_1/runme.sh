...
HD_PWD='D:/HDA/2_sem/DesignAndTestOfMicroelectronics/Lab/Lab3/Streaming_2_D_FIR_Filter_fil/fpgaproj/Streaming_2_D_FIR_Filter_fil.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Streaming_2_D_FIR_Filter_fil.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Streaming_2_D_FIR_Filter_fil.tcl -notrace
