-- -------------------------------------------------------------
-- 
-- File Name: Streaming_VHDL\fil_videosharp_sim\Aligned_Pulse.vhd
...
-- Source Path: fil_videosharp_sim/Streaming 2-D FIR Filter/Line Memory/Aligned Demux/Aligned Pulse
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Aligned_Pulse IS
...
BEGIN
  Aligned_Pulse_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      earlyPulse_reg <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS Aligned_Pulse_1_process;

  Aligned_Pulse_1_output : PROCESS (earlyPulse, earlyPulse_reg, valid)
  BEGIN
    ...
    END IF;
  END PROCESS Aligned_Pulse_1_output;
