-- -------------------------------------------------------------
-- 
-- File Name: Streaming_VHDL\fil_videosharp_sim\eML_Counter_block2.vhd
...
BEGIN
  ...
  BEGIN
    IF reload = '1' THEN 
      nextCount_tmp <= to_unsigned(16#01#, 8);
    ELSIF enb_1 = '1' THEN 
      ...
      END IF;
      IF cast <= to_unsigned(16#000000F0#, 8) THEN 
