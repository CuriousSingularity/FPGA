-- -------------------------------------------------------------
-- 
-- File Name: Streaming_VHDL\fil_videosharp_sim\Repeat_Counter.vhd
...
-- Source Path: fil_videosharp_sim/Streaming 2-D FIR Filter/Line Memory/Line Memory Controller/Read Control/Repeat 
-- Counte
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF Repeat_Counter IS

  -- Component Declarations
  COMPONENT eML_Counter_block3
  ...
  FOR ALL : eML_Counter_block3
    USE ENTITY work.eML_Counter_block3(rtl);
...
BEGIN
  u_eML_Counter : eML_Counter_block3
