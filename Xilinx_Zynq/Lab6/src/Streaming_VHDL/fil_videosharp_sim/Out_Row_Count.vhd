-- -------------------------------------------------------------
-- 
-- File Name: Streaming_VHDL\fil_videosharp_sim\Out_Row_Count.vhd
...
-- Source Path: fil_videosharp_sim/Streaming 2-D FIR Filter/Line Memory/Line Memory Controller/Out Row Count
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Out_Row_Count IS

  -- Component Declarations
  COMPONENT eML_Counter_block
  ...
  FOR ALL : eML_Counter_block
    USE ENTITY work.eML_Counter_block(rtl);
...
BEGIN
  u_eML_Counter : eML_Counter_block
