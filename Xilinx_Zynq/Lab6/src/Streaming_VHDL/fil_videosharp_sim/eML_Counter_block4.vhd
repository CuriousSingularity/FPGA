-- -------------------------------------------------------------
-- 
-- File Name: Streaming_VHDL\fil_videosharp_sim\eML_Counter_block4.vhd
...
END eML_Counter_block4;


ARCHITECTURE rtl OF eML_Counter_block4 IS
...
BEGIN
  ...
  eML_Counter_output : PROCESS (currentCount_unsigned, enb_1, loadVal_unsigned, reload)
  ...
  BEGIN
    ...
    -- end
    IF reload = '1' THEN 
      nextCount_tmp <= loadVal_unsigned;
    ELSIF enb_1 = '1' THEN 
      add_cast := signed(resize(currentCount_unsigned, 32));
      IF (add_cast + 1) <= to_signed(16#00000001#, 32) THEN 
        ...
        END IF;
      ELSE 
        nextCount_tmp <= to_unsigned(16#0#, 2);
      END IF;
    ELSE 
