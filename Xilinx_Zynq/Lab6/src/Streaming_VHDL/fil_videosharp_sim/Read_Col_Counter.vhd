-- -------------------------------------------------------------
-- 
-- File Name: Streaming_VHDL\fil_videosharp_sim\Read_Col_Counter.vhd
...
-- Source Path: fil_videosharp_sim/Streaming 2-D FIR Filter/Line Memory/Line Memory Controller/Read Col Counter
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END Read_Col_Counter;


ARCHITECTURE rtl OF Read_Col_Counter IS

  -- Component Declarations
  COMPONENT eML_Counter_block1
  ...
  FOR ALL : eML_Counter_block1
    USE ENTITY work.eML_Counter_block1(rtl);
...
BEGIN
  u_eML_Counter : eML_Counter_block1
