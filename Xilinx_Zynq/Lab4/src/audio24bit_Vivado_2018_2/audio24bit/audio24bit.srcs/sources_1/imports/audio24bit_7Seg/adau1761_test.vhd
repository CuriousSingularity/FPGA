...
--               7-segment display added on Pmods
----------------------------------------------------------------------------------
library IEEE;
...
entity adau1761_test is
    Port ( clk_100  : in    STD_LOGIC;
           ...
           sw       : in    STD_LOGIC_VECTOR(7 downto 0); -- filter select
			  seg		  : out	 STD_LOGIC_VECTOR(6 downto 0); -- 7segment
			  segsel	  : out   STD_LOGIC							 -- cathode
           );
end adau1761_test;
   ...
   begin
      if rising_edge(clk_48) then
         sw_synced <= sw;
			...
			WHEN "00000010"=>seg<="1011011"; -- 2
			WHEN "00000011"=>seg<="1001111"; -- 3
			WHEN OTHERS=>seg<="1111001"; -- E for error
			END CASE;
