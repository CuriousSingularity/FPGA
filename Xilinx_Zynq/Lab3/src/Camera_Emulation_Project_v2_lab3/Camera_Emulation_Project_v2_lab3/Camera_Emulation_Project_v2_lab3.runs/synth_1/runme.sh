...
HD_PWD='H:/student job/Lab work/lab3/Camera_Emulation_Project_v2_lab3/Camera_Emulation_Project_v2_lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Camera_Emulator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Camera_Emulator.tcl
