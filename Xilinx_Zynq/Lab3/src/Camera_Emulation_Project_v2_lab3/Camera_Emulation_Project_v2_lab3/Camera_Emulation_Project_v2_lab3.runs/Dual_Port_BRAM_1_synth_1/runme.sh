...
HD_PWD='H:/student job/Lab work/lab3/Camera_Emulation_Project_v2_lab3/Camera_Emulation_Project_v2_lab3.runs/Dual_Port_BRAM_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dual_Port_BRAM_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dual_Port_BRAM_1.tcl
